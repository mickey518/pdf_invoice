...
public class InvoiceVO {
    ...
    private String totalAmount; //发票金额
    private String totalAmountString; //大写金额
    private String taxAmount; //发票税额
    private String amount; //不含税金额
    ...
    private List<InvoiceDetailVO> detailList; //发票详情
    ...
    public List<InvoiceDetailVO> getDetailList() {
        return detailList;
    }

    public void setDetailList(List<InvoiceDetailVO> detailList) {
